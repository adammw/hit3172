...
bool bitmap_part_point_collision(bitmap bmp, int32_t x, int32_t y, const rectangle &part, const point2d &pt);
bool bitmap_part_point_collision(bitmap bmp, int32_t x, int32_t y, const rectangle &part, float ptX, float ptY);
bool bitmap_point_collision(bitmap bmp, int32_t x, int32_t y, const point2d &pt);
bool bitmap_rect_collision(bitmap bmp, const point2d &pt, const rectangle &part, const rectangle &rect);
bool bitmap_rect_collision(bitmap bmp, int32_t x, int32_t y, const rectangle &rect);
bool bitmap_rect_collision(bitmap bmp, int32_t x, int32_t y, const rectangle &part, const rectangle &rect);
...
bool cell_bitmap_collision(bitmap bmp1, int32_t cell, int32_t x1, int32_t y1, bitmap bmp2, int32_t x2, int32_t y2, const rectangle &part);

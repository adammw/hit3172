...
circle bitmap_cell_circle(bitmap bmp, const point2d &pt);
circle bitmap_cell_circle(bitmap bmp, int32_t x, int32_t y);
rectangle bitmap_cell_rectangle(bitmap bmp);
rectangle bitmap_cell_rectangle(const point2d &pt, bitmap bmp);
rectangle bitmap_cell_rectangle(float x, float y, bitmap bmp);
circle bitmap_circle(bitmap bmp, const point2d &pt);
circle bitmap_circle(bitmap bmp, int32_t x, int32_t y);
int32_t bitmap_height(const bitmap_cell &bmp);
rectangle bitmap_rectangle(bitmap bmp);
rectangle bitmap_rectangle(float x, float y, bitmap bmp);
int32_t bitmap_width(const bitmap_cell &bmp);
...
void draw_bitmap(const char *name, const point2d &position);
void draw_bitmap(bitmap src, const point2d &position);
void draw_bitmap(bitmap dest, bitmap src, const point2d &position);
void draw_bitmap(bitmap dest, bitmap src, int32_t x, int32_t y);
void draw_bitmap_cell(const bitmap_cell &src, const point2d &position);
void draw_bitmap_cell(const bitmap_cell &src, float x, float y);
void draw_bitmap_cell(bitmap dest, const bitmap_cell &src, const point2d &position);
void draw_bitmap_cell(bitmap dest, const bitmap_cell &src, int32_t x, int32_t y);
void draw_bitmap_cell_on_screen(const bitmap_cell &src, const point2d &position);
void draw_bitmap_cell_on_screen(const bitmap_cell &src, int32_t x, int32_t y);
void draw_bitmap_on_screen(bitmap src, const point2d &position);
void draw_bitmap_part(bitmap src, const rectangle &source, const point2d &position);
void draw_bitmap_part(bitmap src, const rectangle &source, float x, float y);
void draw_bitmap_part(bitmap dest, bitmap src, const rectangle &source, const point2d &position);
void draw_bitmap_part(bitmap dest, bitmap src, const rectangle &source, int32_t x, int32_t y);
void draw_bitmap_part(bitmap dest, bitmap src, int32_t srcX, int32_t srcY, int32_t srcW, int32_t srcH, int32_t x, int32_t y);
void draw_bitmap_part_on_screen(bitmap src, const rectangle &source, const point2d &position);
void draw_bitmap_part_on_screen(bitmap src, const rectangle &source, int32_t x, int32_t y);
void draw_cell(bitmap src, int32_t cell, const point2d &position);
void draw_cell(bitmap dest, bitmap src, int32_t cell, const point2d &position);
void draw_cell(bitmap src, int32_t cell, float x, float y);
void draw_cell(bitmap dest, bitmap src, int32_t cell, float x, float y);
void draw_cell_on_screen(bitmap src, int32_t cell, const point2d &position);
void draw_cell_on_screen(bitmap src, int32_t cell, float x, float y);
void free_bitmap(bitmap &bitmapToFree);
bitmap load_bitmap(const char *filename, bool transparent, color transparentColor);
bool same_bitmap_cell(const bitmap_cell &bmp1, const bitmap_cell &bmp2);

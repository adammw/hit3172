...
void rpn_calculator::add() {
	...
	if ( _operands.size() < 2) {
		throw string("Insufficient operators for the add command.");
	}
...
void rpn_calculator::subtract() {
	...
	if ( _operands.size() < 2) {
		throw string("Insufficient operators for the subtract command.");
	}
...
void rpn_calculator::multiply() {
	...
	if ( _operands.size() < 2) {
		throw string("Insufficient operators for the multiply command.");
	}
...
void rpn_calculator::divide() {
	...
	if ( _operands.size() < 2) {
		throw string("Insufficient operators for the divide command.");
	}
